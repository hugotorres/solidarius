      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
          <div class="widget subscribe no-box">
            ...
            <p>Somos una plataforma que tiene como principal objetivo impulsar economias informales y formales (MiPymes y Pymes) de forma gratuita.</p>
          </div>
        </div>
            ...
            <ul class="thumbnail-widget">
              <li>
                <div class="thumb-content">
                  <a href="/register">Ofrece tus servicios</a>
                </div>
              </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
          ...
          <div class="widget no-box">
            ...
            <ul class="social-footer2">
              ...
              <li class="">
                <a
                  href="https://www.facebook.com/necesitu.necesitu.9?ref=bookmarks"
                  target="_blank"
                  title="Facebook">
                  <img
                    alt="Facebook"
              ...
              <li class="">
                <a href="https://twitter.com/TuNecesi" target="_blank" title="Twitter">
                  <img
                    alt="Twitter"
                    width="30"
                    height="30"
              ...
              <li class="">
                <a
                  title="instagram"
                  target="_blank"
                  href="https://www.instagram.com/necesitu/">
                  <img
                    alt="instagram"
                    width="30"
                    height="30"
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <p>Copyright Necesitu © 2020. All rights reserved.</p>
        </div>
      </div>
    </div>
  </div>
